    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-rose-50 py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-rose-800 max-w-3xl mx-auto">
            Conheça nossa história e nossa paixão por criar experiências inesquecíveis
          </p>
        </div>
      </div>
            ...
            <div className="relative z-10 bg-white/80 backdrop-blur-sm p-6 md:p-8 rounded-xl">
              ...
              <div className="space-y-4 text-gray-700">
                <p className="font-semibold text-lg">
                  Viagens planejadas com cuidado e exclusividade
                </p>
                <p>
                  A Bella Renda & Viagens transforma cada jornada em uma experiência autêntica e
                  inesquecível. Criamos roteiros personalizados para garantir conforto e segurança.
                  Cuidamos de tudo, do planejamento ao retorno, para que você aproveite cada destino
                  sem preocupações.
                </p>
              </div>
            </div>
