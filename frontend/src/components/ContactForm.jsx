...
export default function ContactForm({ packageTitle = '' }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const leadData = {
        ...
        cf_package: packageTitle || '',
        conversion_identifier: packageTitle ? 'formulario-pacote' : 'formulario-contato-site',
      };

      console.log('Enviando lead para RD Station...', leadData);
  ...
  return (
    <div className="w-full">
      {packageTitle && (
        <div className="mb-4 p-3 bg-[hsl(340,45%,95%)] border border-[hsl(340,45%,80%)] rounded-md">
          <p className="text-sm text-[hsl(340,45%,30%)]">
            <span className="font-medium">Pacote selecionado:</span> {packageTitle}
          </p>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-[hsl(340,45%,54%)] focus:border-[hsl(340,45%,54%)] disabled:bg-gray-100 disabled:cursor-not-allowed"
        ...
        <div className="pt-2">
          <button
            type="submit"
            disabled={isSubmitting}
            className={`w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[hsl(340,45%,54%)] hover:bg-[hsl(340,45%,45%)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[hsl(340,45%,70%)] disabled:opacity-50 disabled:cursor-not-allowed ${
